...
/**
 * Created by 101912 on 2017/11/16.
 */
...
public class TTFParser {
    ...
    public
    static
    int FONT_SUBFAMILY_NAME
            = 2;

    public
    static
    int UNIQUE_FONT_IDENTIFIER
            = 3;
    ...
    public
    static
    int LICENSE_INFO_URL
            = 14;


    private Map<Integer, String> fontProperties
    ...
    private void parseInner(RandomAccessFile randomAccessFile)
        ...
        for (int i
            ...
            } else if (tableDirectory.name
                    == null
                    || tableDirectory.name.length()
                    == 0) {
        ...
        for (int i
            ...
            String temp =
                    new String(bf, Charset.forName("utf-16"));
